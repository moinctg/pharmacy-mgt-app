# Generated by Django 3.2.6 on 2022-10-17 11:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('despense_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pharmacy.dispense')),
        ...
        migrations.AddField(
            model_name='dispense',
            name='drug_id',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='pharmacy.stock'),
        ),
        migrations.AddField(
            model_name='dispense',
            name='store_id',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='pharmacy.store'),
        ),
        migrations.AddField(
            model_name='dispense',
            name='storekipper',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='pharmacy.storekipper'),
        ),
        migrations.CreateModel(
            name='Sales',
            fields=[
